            ...
            <div key={movie.maPhim} className="relative group">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black bg-opacity-60">
                      <div className="flex flex-col items-center">
                        ...
                        <Button type="default" shape="round" icon={<ShoppingCartOutlined />} size="large" className="text-white bg-red-500 hover:bg-red-600">
                          Mua Vé
                        </Button>
                      </div>
                    </div>
              ...
              >
                <Meta
                  ...
                  title={movie.tenPhim}
                  description={
                    <Typography.Paragraph ellipsis={{ rows: 2 }} className="flex-1 text-left text-sm  font-medium text-gray-600 capitalize">
                      {movie.moTa}
